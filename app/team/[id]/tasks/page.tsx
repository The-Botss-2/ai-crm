...
export default function TasksPage() {
    ...
    const filteredTasks =
        (activeTab === 'all' ? tasks : tasks.filter((t: any) => t.status === activeTab))
    ...
    return (
        <div className="p-6">
            ...
            <div className="flex justify-between items-center mb-4">
                ...
                <button className="bg-blue-100 text-blue-800 px-4 py-2 rounded-lg text-xs"
                    onClick={() => {
                        setEditingTask(null);
                        setDrawerOpen(true);
                    }}
                ...
                <table className="min-w-full text-sm border-separate border-spacing-y-2">
                    ...
                    <tbody>
                        ...
                        {filteredTasks.length === 0 && (
                            <tr>
                                <td colSpan={5} className="text-center px-4 py-6 text-muted-foreground">
                                    No tasks found.
                                </td>
                            </tr>
                        )}
