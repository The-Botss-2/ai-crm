            ...
            leads.map((lead) => (
              ...
              >
                ...
                <td className="px-4 py-2 rounded-r-md space-x-2">
                  {
                    role != 'readonly' && (<button onClick={() => onEdit(lead)} className="bg-blue-100 cursor-pointer text-blue-800 p-1 rounded hover:underline">
                      <FiEdit3 size={16} />
                    </button>)
                  }
                  {
                    role != 'readonly' && (<button onClick={() => onDelete(lead)} className="bg-red-100 cursor-pointer text-red-800 p-1 rounded hover:underline">
                      <MdDeleteOutline size={16} />
                    </button>)
                  }
                  <button onClick={() => onPreview(lead)} className="bg-green-100 text-green-800 cursor-pointer p-1 rounded hover:underline">
