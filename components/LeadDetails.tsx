...
const LeadDetails = ({ leadId, teamId, userID }: LeadProps) => {
    ...
    const { data: Conversation, error:ConversationError, mutate: mutateConversation } = useSWR<ConversationType>(`${process.env.NEXT_PUBLIC_CALLING_AGENT_URL}/api/conversations/by-lead?lead_id=${leadId}`, fetcher);
